    ...
    <header class="site-header">
        <div class="container nav-wrap">
            ...
            <nav class="main-nav" data-menu>
                ...
                @auth
                    <a href="{{ route('membership.create') }}">Membership Apply</a>
                @else
                    <a href="{{ route('register') }}">Join Community</a>
                @endauth
            </nav>
            <div class="auth-links">
                @auth
                    @if(auth()->user()->is_admin)
                        <a href="{{ route('admin.dashboard') }}" class="btn btn-subtle">Admin Panel</a>
                    @endif
